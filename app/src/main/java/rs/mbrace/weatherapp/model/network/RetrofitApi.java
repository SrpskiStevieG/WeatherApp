...
public interface RetrofitApi {
    ...
    @GET("weather")
    Call<CurrentForecast> getCurrentForecast(@Query("q") String cityName, @Query("mode") String mode, @Query("APPID") String appID);

    @GET("weather")
    Call<CurrentForecast> getCurrentForecast(@Query("q") String cityName, @Query("country") String countryCode, @Query("mode") String mode, @Query("APPID") String appID);
